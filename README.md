...
```javascript
import reviver from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-reviver-float64@deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/complex-reviver-float64/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/complex-reviver-float64/actions/workflows/test.yml
