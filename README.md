...
```javascript
reviver = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-reviver-float64@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var reviver = require( 'path/to/vendor/umd/complex-reviver-float64/index.js' )
```
